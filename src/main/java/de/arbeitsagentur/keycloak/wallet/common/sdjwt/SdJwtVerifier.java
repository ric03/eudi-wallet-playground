...
public class SdJwtVerifier {
    ...
    public SdJwtVerifier(ObjectMapper objectMapper, TrustListService trustListService) {
    ...
    public void verifyHolderBinding(String keyBindingJwt,
        ...
        if (keyToUse == null || !TrustListService.verifyWithKey(holderBinding, keyToUse)) {
